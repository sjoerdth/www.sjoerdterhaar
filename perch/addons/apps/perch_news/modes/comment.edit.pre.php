<?php
    ...
    $Comments = new PerchNews_Comments;
    $Posts = new PerchNews_Posts;
    include(realpath('.').'/../../PerchNews_Akismet.class.php');


    if (!$CurrentUser->has_priv('perch_news.comments.moderate')) {
    ...
    $Template->set('news/comment.html', 'news');
