<?php
    ...
    if ($edit_mode=='define') {
        ...
        /* ---- FORM ---- */
        echo $Form->form_start('news-edit', 'magnetic-save-bar');
            ...
            /* ---- COMMENTS ---- */
            #if ($CurrentUser->has_priv('perch_news.comments.enable')) {
           ...
           #}
            ...
            if ($CurrentUser->has_priv('perch_news.post.publish')) $opts[] = array('label'=>$Lang->get('Published'), 'value'=>'Published');
