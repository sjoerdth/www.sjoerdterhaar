<?php
    ...
    echo $HTML->para('This page lists news post authors.');
    echo $HTML->para('There is no need to create a new author. Create a regular user account as normal, and a news author entry will be created the first time they post.');
