...
class PerchNews_Cache
{
    ...
    public static function save_static($key, $contents)
    {
        ...
        file_put_contents(PerchUtil::file_path(PERCH_RESFILEPATH.'/perch_news.'.$key.'.cache'), $contents);
    }
    ...
    public static function get_static($key, $minutes)
    {
        ...
        $file = PerchUtil::file_path(PERCH_RESFILEPATH.'/perch_news.'.$key.'.cache');
    ...
    {
        $files = glob(PerchUtil::file_path(PERCH_RESFILEPATH.'/perch_news.*.cache'));
