...
<head>
	<meta charset="utf-8">
	<title>Perch News Example Archive Page</title>
		...
		<div class="primary-content">
		    ...
		    <?php
		        ...
		        */
		        ...
		        /* --------------------------- POSTS BY CATEGORY --------------------------- */
		        if (perch_get('cat')) {
		            echo '<h1>Archive of: '.perch_news_category(perch_get('cat'), true).'</h1>';
		        ...
		        /* --------------------------- POSTS BY TAG --------------------------- */
		        if (perch_get('tag')) {
		            echo '<h1>Archive of: '.perch_news_tag(perch_get('tag'), true).'</h1>';
		        ...
		        if (perch_get('author')) {
		        	...
		        	echo '<h1>Posts by '.perch_news_author(perch_get('author'), array(
